...
<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <a href="{{ route('employees.index') }}" class="rounded-lg p-2 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600">
    ...
    <div class="space-y-6">
        ...
        <div>
            <a href="{{ route('employees.index') }}" class="text-sm font-medium text-gray-500 hover:text-gray-700 hover:underline">
                Back to Employees
            </a>
        </div>
    </div>
