                    ...
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            <a href="{{ route('api-explorer.show', ['company' => $company]) }}"
                               class="inline-flex items-center gap-1.5 rounded-xl border border-indigo-200 px-4 py-2 text-sm font-medium text-indigo-600 transition-colors hover:bg-indigo-50">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
